...
API_KEY = 'f8f68872b57d6da32d6a374afef84e0e' ## Insert Scraperapi API key here. Signup here for free trial with 5,000 requests: https://www.scraperapi.com/signup
...
class GoogleSpider(scrapy.Spider):
    ...
    def start_requests(self):
        queries = ['project+pegasus+india+news'] ## Enter keywords here ['keyword1', 'keyword2', 'etc']
